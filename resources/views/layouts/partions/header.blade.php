    ...
    <div class="header-inner">
      <div class="col-sm-4 col-xs-6 header-left">
        <div class="shipping">
          ...
          <div class="shipping-text">038 442 8234<br>
            <span class="shipping-detail">24/7 Online Support</span></div>
        </div>
      </div>
      <div class="col-sm-4 col-xs-12 header-middle">
        <div class="header-middle-top">
          <div id="logo"> <a href="{{route('frontend.home.index')}}"><img src="{{ asset('image/logopage.png') }}" width="150px" title="Thành Mobile" alt="Thành Mobile" class="img-responsive" /></a> </div>
        </div>
      </div>
          ...
          <ul class="dropdown-menu pull-right cart-dropdown-menu">
            <li>
              <table class="table table-striped">
                <tbody>
                  <tr>
                    <td class="text-center"><a href="#"><img class="img-thumbnail" title="lorem ippsum dolor dummy" alt="lorem ippsum dolor dummy" src="{{ asset('image/product/7product50x59.jpg') }}"></a></td>
